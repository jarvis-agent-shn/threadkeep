...
(function () {
  ...
  function reflectProUI() {
    ...
    if (els.devProToggle) els.devProToggle.checked = isProUser;
  ...
  async function onDevProToggle() {
    if (els.devProToggle) await self.TK.Pro.setProForTesting(els.devProToggle.checked);
  ...
  function wireEvents() {
    ...
    if (els.devProToggle) els.devProToggle.addEventListener('change', onDevProToggle);
  }
